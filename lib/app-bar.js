...
var AppBar = React.createClass({
  ...
  render: function render() {
    ...
    var other = _objectWithoutProperties(_props, ['title', 'iconStyleRight', 'showMenuIconButton', 'iconElementLeft', 'iconElementRight', 'iconClassNameLeft', 'iconClassNameRight', 'className', 'style', 'titleStyle', 'zDepth', 'children']);
    ...
    if (title) {
      ...
      titleElement = typeof title === 'string' || title instanceof String ? React.createElement(
        ...
        'div',
        { style: this.prepareStyles(styles.mainElement, titleStyle) },
        title
      );
    }
