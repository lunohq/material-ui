...
var ListItem = React.createClass({
  ...
  render: function render() {
    ...
    if (leftIcon) {
      this._pushElement(contentChildren, leftIcon, this.mergeStyles(styles.icons, styles.leftIcon, this.props.leftIconStyle));
    }

    if (rightIcon) {
      this._pushElement(contentChildren, rightIcon, this.mergeStyles(styles.icons, styles.rightIcon, this.props.rightIconStyle));
    }

    if (leftAvatar) {
      this._pushElement(contentChildren, leftAvatar, this.mergeStyles(styles.avatars, styles.leftAvatar, this.props.leftAvatarStyle));
    }

    if (rightAvatar) {
      this._pushElement(contentChildren, rightAvatar, this.mergeStyles(styles.avatars, styles.rightAvatar, this.props.rightAvatarStyle));
    }

    if (leftCheckbox) {
      this._pushElement(contentChildren, leftCheckbox, this.mergeStyles(styles.leftCheckbox, this.props.leftCheckboxStyle));
    }
    ...
    if (primaryText) {
      var secondaryTextElement = this._createTextElement(this.mergeAndPrefix(styles.primaryText, this.props.primaryTextStyle), primaryText, 'primaryText');
      contentChildren.push(secondaryTextElement);
    }

    if (secondaryText) {
      var secondaryTextElement = this._createTextElement(this.mergeAndPrefix(styles.secondaryText, this.props.secondaryTextStyle), secondaryText, 'secondaryText');
      contentChildren.push(secondaryTextElement);
    }
